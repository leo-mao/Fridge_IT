...
Vue.use(MultiLanguage, {
  ...
  english: {
    ...
    slot_sub_hero: 'Here you can see detailed informations about the slot',
    ...
    slot_error_text: 'Error while loading informations about the slot. There is no slot with this id.',
    slot_warning_text: 'There is no bottle in this slot.',
    slot_return: 'Return to slots.',
    navbar_home: 'Home',
  ...
  german: {
    ...
    slot_warning_text: 'In diesem Slot befindet sich aktuell keine Flasche.',
    slot_return: 'Zurück zur Slotübersicht.',
